...
// import citiesData from "../../city/citiesData";
...
//     switch (step) {
//       case 0:
//         return <AddressForm cities={citiesData}/>;
//       case 1:
//         return <Review />;
//       case 2:
//         return <PaymentForm />;
...
import { ValidationRules } from "./ValidationRules";
import { yupResolver } from "@hookform/resolvers/yup";
import AddressForm from "./AddressForm";  // Make sure the AddressForm component is correctly imported
import PaymentForm from "./PaymentForm";
import Review from "./Review";
